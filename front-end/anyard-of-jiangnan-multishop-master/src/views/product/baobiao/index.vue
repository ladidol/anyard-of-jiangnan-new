  ...
  data: function() {
    return {
      ...
      viewCount: {
        ...
        xAxis: {
          data: ["2023-06-20","2023-06-21","2023-06-22","2023-06-23",'2023-06-24','2023-06-25','2023-06-26'],
          axisLine: {
            lineStyle: {
              // 设置x轴颜色
              color: "#666"
        ...
        series: [
          {
            ...
            type: "pie",
            roseType: "radius",
            data: [{value:55,name:'青年'},{value:35,name:'中年'},{value:10,name:'老年'}]
          }
        ]
      },
      userAreaMap: {
