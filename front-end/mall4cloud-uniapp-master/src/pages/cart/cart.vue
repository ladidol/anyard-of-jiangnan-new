...
export default {
  ...
  methods: {
    ...
    handleEditOper(operType) {
      ...
      let params = {
        url: '/anyard-of-jiangnan-product/a/shop_cart/delete_item',
        method: 'DELETE',
        data: selectIds,
        callBack: res => {
          uni.showToast({
    ...
    changeNumber(shopIndex,prodIndex,num) {
      ...
      const params = {
        url: '/anyard-of-jiangnan-product/a/shop_cart/change_item',
        method: 'POST',
        data: reqData,
        callBack: res => {
          this.getCartInfo()
    ...
    getCartInfo() {
      const params = {
        url: '/anyard-of-jiangnan-product/a/shop_cart/info',
        method: 'GET',
        data: {},
        callBack: res => {
    ...
    calTotalPrice() {
      const params = {
        url: '/anyard-of-jiangnan-product/a/shop_cart/check_items',
        method: 'POST',
    ...
    getProdInfo(spuId) {
      uni.showLoading()
      const params = {
        url: '/anyard-of-jiangnan-product/ua/spu/prod_info',
        method: 'GET',
        data: {
          spuId: spuId
        },
    ...
    getDefaultAddrStr() {
      uni.showLoading()
      const params = {
        url: '/anyard-of-jiangnan-user/user_addr/list',
        method: 'GET',
        callBack: res => {
          if (!res.length) {
            uni.hideLoading()
