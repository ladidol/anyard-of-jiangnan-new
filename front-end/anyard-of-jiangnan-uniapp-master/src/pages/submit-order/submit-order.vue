...
export default {
  ...
  methods: {
    ...
    saveAndUse() {
      ...
      // 保存地址
      const params = {
        url: '/anyard-of-jiangnan-user/a/user_addr',
        method: 'POST',
        data: {
          addr: this.addr,
          area: this.area,
    ...
    */
    ...
    saveAndUse() {
      ...
      // 保存地址
      const params = {
        url: '/anyard-of-jiangnan-user/user_addr',
        method: 'POST',
        data: {
          addr: this.addr,
          area: this.area,
    ...
    loadOrder(isFirst) {
      const params = {
        url: '/anyard-of-jiangnan-order/a/order/confirm',
        method: 'POST',
        data: {
          addrId:this.addrId,
          dvyType: 3,
    ...
    submitOrder() {
      ...
      const params = {
        url: '/anyard-of-jiangnan-order/a/order/submit',
        method: 'POST',
        data: {
