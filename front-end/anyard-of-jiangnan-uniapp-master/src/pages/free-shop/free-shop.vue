...
export default {
  ...
  methods: {
    ...
    getMyShopInfo() {
      var params = {
        url: '/anyard-of-jiangnan-multishop/my_shop_detail',
        method: 'GET',
        callBack: res => {
          uni.hideLoading()
          if (res) {
    ...
    getShopAudit() {
      var params = {
        url: '/anyard-of-jiangnan-multishop/a/shop_auditing/shop_audit',
        method: 'GET',
        callBack: res => {
          uni.hideLoading()
    ...
    examineShopName() {
      ...
      var params = {
        url: '/anyard-of-jiangnan-multishop/ua/shop_detail/check_shop_name',
        method: 'GET',
        data: {
    ...
    applyToOpenAShop() {
      ...
      uni.showLoading()
      var params = {
        url: '/anyard-of-jiangnan-multishop/my_shop_detail/create',
        method: 'POST',
        data: shopDetailDTO,
        callBack: res => {
          uni.hideLoading()
