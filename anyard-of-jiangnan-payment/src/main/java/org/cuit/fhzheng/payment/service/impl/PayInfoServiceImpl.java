package org.cuit.fhzheng.payment.service.impl;
...
import org.cuit.fhzheng.payment.constant.PayStatus;
import org.cuit.fhzheng.payment.dto.PayInfoDTO;
import org.cuit.fhzheng.payment.mapper.PayInfoMapper;
...
public class PayInfoServiceImpl implements PayInfoService {
    ...
    public PayInfoBO pay(Long userId, PayInfoDTO payParam) {
        ...
        if (!ordersAmountAndIfNoCancelResponse.isSuccess()) {
            throw new anyardOfJiangnanException(ordersAmountAndIfNoCancelResponse.getMsg());
        }
