package org.cuit.fhzheng.common.handler;
...
public class DefaultExceptionHandlerConfig {
	...
	@ExceptionHandler(anyardOfJiangnanException.class)
	public ResponseEntity<ServerResponseEntity<Object>> anyardOfJiangnanExceptionHandler(anyardOfJiangnanException e) {
		logger.error("anyardOfJiangnanExceptionHandler", e);
