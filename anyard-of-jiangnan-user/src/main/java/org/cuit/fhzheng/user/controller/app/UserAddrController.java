...
import org.cuit.fhzheng.user.dto.UserAddrDTO;
...
public class UserAddrController {
    ...
    public ServerResponseEntity<Void> delete(@RequestParam Long addrId) {
        ...
        if (dbUserAddr == null) {
            ...
            throw new anyardOfJiangnanException("默认地址不能删除");
        }
