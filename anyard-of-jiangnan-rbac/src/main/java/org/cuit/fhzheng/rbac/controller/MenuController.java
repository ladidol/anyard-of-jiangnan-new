...
import org.cuit.fhzheng.rbac.dto.MenuDTO;
...
import org.cuit.fhzheng.rbac.vo.RouteMetaVO;
import org.cuit.fhzheng.rbac.vo.RouteVO;
...
public class MenuController {
	...
	private Menu checkAndGenerate(@RequestBody @Valid MenuDTO menuDTO) {
		...
		if(!Objects.equals(userInfoInTokenBO.getTenantId(),0L)){
			throw new anyardOfJiangnanException("无权限操作！");
		}
