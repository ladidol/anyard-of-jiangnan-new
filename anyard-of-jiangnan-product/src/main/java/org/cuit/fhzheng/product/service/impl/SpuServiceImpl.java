...
import org.cuit.fhzheng.api.product.bo.EsAttrBO;
import org.cuit.fhzheng.api.product.bo.EsProductBO;
import org.cuit.fhzheng.api.product.vo.CategoryVO;
import org.cuit.fhzheng.api.product.vo.SpuAttrValueVO;
...
import org.cuit.fhzheng.product.mapper.SpuMapper;
import org.cuit.fhzheng.product.service.*;
import org.cuit.fhzheng.api.product.vo.SpuVO;
import org.cuit.fhzheng.product.model.Spu;
import org.cuit.fhzheng.product.model.SpuAttrValue;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void changeSpuStatus(Long spuId, Integer status) {
        ...
        if (!Objects.equals(status, StatusEnum.ENABLE)) {
            ...
            if (!imgRes.isSuccess()) {
                throw new anyardOfJiangnanException("服务异常");
            }
        }
    }
    ...
    public void deleteById(Long spuId) {
        ...
        if(Objects.isNull(spuVO) || Objects.equals(spuVO.getStatus(), StatusEnum.DELETE.value())){
            throw new anyardOfJiangnanException("商品不存在或者已被删除！");
        }
        // 删除商品、sku信息(逻辑删除)
