...
import org.cuit.fhzheng.api.vo.*;
import org.cuit.fhzheng.api.vo.search.*;
...
import org.cuit.fhzheng.search.constant.*;
...
public class ProductSearchManager {
    ...
    public List<SpuSearchVO> list(ProductSearchDTO productSearchDTO) {
        ...
        try {
            ...
            throw new anyardOfJiangnanException("搜索服务出了点小差，请稍后再试", e);
        }
        return spuList;
    }
